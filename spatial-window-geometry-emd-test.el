;;; spatial-window-geometry-emd-test.el --- Tests for EMD variant -*- lexical-binding: t; -*-

;;; Commentary:
;; Invariant tests for spatial-window-geometry-emd.el

;;; Code:

(require 'ert)
(require 'spatial-window-geometry-emd)
(require 'spatial-window-geometry-variant-test-common)

(ert-deftest spatial-window-emd-invariants ()
...
(provide 'spatial-window-geometry-emd-test)

;;; spatial-window-geometry-emd-test.el ends here
