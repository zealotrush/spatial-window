;;; spatial-window-geometry-hungarian-test.el --- Tests for Hungarian variant -*- lexical-binding: t; -*-

;;; Commentary:
;; Invariant tests for spatial-window-geometry-hungarian.el

;;; Code:

(require 'ert)
(require 'spatial-window-geometry-hungarian)
(require 'spatial-window-geometry-variant-test-common)

(ert-deftest spatial-window-hungarian-invariants ()
...
(provide 'spatial-window-geometry-hungarian-test)

;;; spatial-window-geometry-hungarian-test.el ends here
