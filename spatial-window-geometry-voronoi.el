;;; spatial-window-geometry-voronoi.el --- Weighted Voronoi mapping -*- lexical-binding: t; -*-
...
;;; Commentary:
;; Weighted Voronoi assignment using window centroids and area weights.
...
(defun spatial-window--assign-cells (kbd-rows kbd-cols window-bounds)
  "Assign each cell to nearest weighted centroid (power diagram)."
...
(defun spatial-window--assign-keys (&optional frame window-bounds kbd-layout)
  "Assign keyboard keys to windows based on weighted Voronoi."
...
(provide 'spatial-window-geometry-voronoi)

;;; spatial-window-geometry-voronoi.el ends here
